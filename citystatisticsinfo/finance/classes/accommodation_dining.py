...
class AccommodationDining(Base):
    __tablename__ = "accommodation_dining"
    ...
    def to_list(self):
        return [self.city, self.year2019, self.year2018, self.year2017, self.year2016, self.year2015,
